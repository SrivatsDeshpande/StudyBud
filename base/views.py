...
def registerPage(request):
    ...
    if request.method =='POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'An error occcured.')
...
def room(request, pk):
    ...
    room_messages = room.message_set.all().order_by('-created') # All messages from Messages model that belong to this room
